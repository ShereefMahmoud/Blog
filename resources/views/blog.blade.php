        ...
        <div class="col-lg-12">
          ...
          <nav class="navbar navbar-expand-lg">
            <a class="navbar-brand logo" href="index-2.html">
              <img id="logo-img" class="img-center" src="{{ url('resource_blog/images/logo.png') }}" alt="">
            </a>
            ...
            <div class="right-nav align-items-center d-flex justify-content-end list-inline"> <a class="btn btn-white btn-sm" href="{{ url('login') }}">Login</a>
              <div class="search">
    ...
    <div class="col-lg-12 col-md-6" >
        <div class="post">
          <div class="post-image">
            <img class="img-fluid h-100 w-100" src="{{ url('articleImage/'.$Raw->image) }}" alt="">
          </div>
          <div class="post-desc">
            <div class="post-date"> {{  date('d',$Raw->date) }}<span>{{  date('F Y',$Raw->date) }}</span>
            </div>
            ...
            <div class="post-author">
              <div class="post-author-img">
                <img class="img-fluid h-20 w-20"  src="{{ url('userImage/'.$Raw->image) }} ?>"  alt="">
              </div>
              <span><?php echo $Raw->userName?></span>
            </div>
          </div>
        </div>
      </div>
